...
private const val BASE_URL = "https://raw.githubusercontent.com/jonapoul/takdevx/main/takdevx-dependency-guard/" +
  "atak-versions/"
...
internal fun Project.registerCheckTakDependenciesTask(
  ...
  val guardFileDir = tasks.named("dependencyGuard").flatMap { task ->
    // Access internal property via reflection since DependencyGuardListTask is internal
    task.javaClass
      .getMethod("getProjectDirectoryDependenciesDir")
      .invoke(task)
  ...
  return tasks.register("checkTakDependencies", CheckDependencies::class.java) { t ->
    ...
    t.guardFileDir.set(guardFileDir)
