...
public abstract class ScenarioTest {
  ...
  public abstract val gradleVersion: String
  public abstract val androidHome: File?

  protected open val rootBuildFile: String by lazy {
    """
      plugins {
  ...
  @TempDir public lateinit var projectRoot: File

  private val createdFiles = mutableListOf<File>()

  @AfterEach
  public fun afterScenarioTest() {
